    ...
    <div id="wrap" style="display: flex; flex-direction: column;">
        ...
        <div style="display: flex;
            ...
            <form action="UpdateCon" method="POST" id="nick-change">
                ...
                <a><input type="text" name="name" placeholder="이름을 입력하세요." style="width: 500px; margin-left: 10px;"></a>
                <a><input type="text" name="id" placeholder="아이디를 입력해주세요."
                        style="width: 500px; margin-left: 10px;"></a>
                <a><input type="text" name="nick" placeholder="변경할 닉네임을 입력해 주세요."
                        style="width: 500px; margin-left: 10px;"></a>
                <button id="editinfo" style="width: 500px; margin-left: 10px;" type="submit" value="update" onclick="nickchange()">수정</button>
            </form>
            ...
            <form action="UpdateCon" method="POST" id="pw-change">
                ...
                <a><input type="password" name="pw" placeholder="변경할 비밀번호를 입력해 주세요."
                        style="width: 500px; margin-left: 10px;"></a>
                <button style="width: 500px; margin-left: 10px;" type="submit" value="update" onclick="pwchange()">변경</button>
            </form>
        </div>
