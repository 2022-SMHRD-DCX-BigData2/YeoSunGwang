...
<body>
	...
	<div id="wrap" class="My1">
		...
		<section>
			<div id="wrap1">
				<br>
				<button onclick="location.href='Exchange_Yeosu.jsp'">여 수</button>
		...
		<div id="MAIN11">
			<section class="posts11">
				<article>
					...
					<div id="img11">
						<img src="images/여수 상품권 5000.png">
					</div>
				...
				<article>
					...
					<div id="img11">
						<img src="images/여수 상품권 10000.png">
					</div>
				...
				<article>
					...
					<div id="img11">
						<img src="images/여수 상품권 30000.png">
					</div>
