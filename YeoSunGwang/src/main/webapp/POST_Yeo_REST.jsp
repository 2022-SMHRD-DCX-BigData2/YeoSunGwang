...
<body>
	...
	<div id="wrap" class="My1">
		...
		<div id="Middle_nav">
			<ul>
				<br>
				<li><a href="POST_Yeo_ALL.html">all</a></li>
				<li><a href="POST_Yeo_REST.html"
					style="font-weight: bold; color: #2EBAAE; text-decoration: underline; text-underline-position: under;">RESTAURANT</a></li>
				<li><a href="POST_Yeo_CAFE.html">CAFE</a></li>
				...
				<li><a href="POST_Yeo_TOUR.html">tour Spot</a></li>
			</ul>
		</div>
