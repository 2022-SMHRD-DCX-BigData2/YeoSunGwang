		...
		<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
			...
			<% Member loginMember=(Member)session.getAttribute("loginMember"); %>
				...
				<body>
					...
					<header id="header">
						<h1>
							<a href="MAIN.jsp"><img src="images/여순광.png" alt="logo" class="logo"></a>
						</h1>
						...
						<div class="links2">
							...
							<%}else{ %>
								<ul>
									<li>
										<%= loginMember.getMem_nick()%> 님 환영합니다
									</li>
						...
						<div
							...
							<form action="UpdateCon" method="POST" id="nick-change">
								...
								<a><input type="text" name="name" placeholder="이름을 입력하세요."
										style="width: 500px; margin-left: 10px;"></a> <a><input type="text" name="id"
										placeholder="아이디를 입력해주세요." style="width: 500px; margin-left: 10px;"></a>
								...
								<div style="margin-left: 1em; margin-top: 1em;">
									<span style="color: red; align-self: center;">변경에 실패했습니다. <br>입력하신 내용을 다시
										확인해주세요.</span>
								</div>
							</form>
					...
					<div class="ourfooter">
						<footer>
							<nav> <a href='#' target='_blank'>Blog</a> | <a href='#' target='_blank'>Github</a> </nav>
							<p>
