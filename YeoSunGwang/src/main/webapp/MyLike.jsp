	...
	<div id="wrap" class="My1">
		...
		<section>
			...
			<nav class="links2" style="margin-bottom: 4em;">
				<ul>
					...
					<!-- 포인트 교환 -->
					<li><a href="MyLike.html"
						style="font-weight: bold; color: #2EBAAE; text-decoration: underline; text-underline-position: under;">좋아요
							누른 글 보기</a></li>
					<!-- 마이 페이지 -->
				</ul>
			</nav>
		...
		<table style="border: 1px solid whitesmoke;" id="boardtable">
			...
			<tr align="center">
				<td>001</td>
				<td>순천</td>
				<td align="left"><a href="view.html">ㅋㅋㅋㅋㅋㅋ</a></td>
				<td>정지맹</td>
				<td>2022-11-24</td>
