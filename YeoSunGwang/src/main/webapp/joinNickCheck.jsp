...
<body style="display: flex; flex-direction: column; align-items: center;">
	<h1>닉네임 중복체크</h1>
		...
		int result = dao.joinNickCheck(nick);
		%>
		...
		<fieldset>
			...
			<form action="joinNickCheck.jsp" method="post" name="joinCheck">
				<div style="display: flex; align-items: center;">
					<div style="margin-left: 1em; margin-right: 1em;">닉네임</div>
		...
		<!-- 6. 선택된아이디는 중복확인창에서 회원가입 페이지로 정보전달  -->
		 <script type="text/javascript">
		    function result(){
		    	...
		    	opener.document.join.nick.value = document.joinCheck.usernick.value;
		    	
		    	//6-3. 회원가입창 제어
		    	opener.document.join.nick.readOnly=true;
