	...
	<div id="wrap" class="My1">
		...
		<table style="border: 1px solid whitesmoke;" id="boardtable">
			...
			<tr align="center">
				...
				<td>광양대부호 정상민</td>
				<td>2022-11-24</td>
				<td>0<i class="fa-solid fa-heart" style="color: red;"></i></td>
			</tr>

			<tr align="center">
				<td>002</td>
				<td>순천</td>
				<td align="left"><a href="view.html">여기는 좀 별로던데요;</a></td>
				<td>광양대부호 정상민</td>
				<td>2022-11-25</td>
				<td>1<i class="fa-solid fa-heart" style="color: red;"></i></td>
			</tr>
		</table>
	</div>
